...
export const ArrowsIcon = ({ width, height, classAditional }: IconProps) => {
    return (
        <Image src='/images/doubleArrowIcon.png'
            alt='Arrow Image'
            width={width} height={height}
            className={`bg-transparent filter brightness-0 invert ${classAditional}`}>
        </Image>
    )
}
