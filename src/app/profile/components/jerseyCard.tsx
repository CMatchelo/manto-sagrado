...
const JerseyCard = ({ jersey, onJerseyClick }: JerseyCardProps) => {
    ...
    return (
        <div className="flex flex-col relative px-2 pt-2 
            ...
            <div>
                <h2 className="font-semibold text-3xl sm:text-xl lg:text-2xl w-full text-black text-center overflow-hidden text-ellipsis">{jersey.team}</h2>
            ...
            <div className="mt-auto">
                <ImageSlide photoFront={jersey.photoFront} photoBack={jersey.photoBack} className="object-cover self-end" />
                <div className="flex flex-row space-x-2 w-full self-end">
